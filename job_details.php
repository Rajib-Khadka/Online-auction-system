...
$sql_company = "SELECT logo, location, state, country, company_details FROM company WHERE name = '$company_name'";
        ...
        <div class="navbar-container">
            <div class="logo">
                <a href="http://localhost/JobPortal/index.php">
                    <img src="http://localhost/JobPortal/Logo/logo3.png" alt="Logo"> </a>
            </div>
            <ul class="nav-links">
            ...
            <div class="banner-container">
                <div class="banner-content">
                    ...
                    <div class="breadcrumb">
                        <a href="index.php">Home</a> | <a href="job.php">Job List</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="dashboard-section">
        <div class="dashboard-content">
            ...
            <div class="content">
                ...
                <div class="right-side">
                    ...
                    <p><strong style="font-weight:500;">Experience:</strong>
                        <?php echo htmlspecialchars($job['experience']); ?></p>
            ...
            <div class="button-container"
                ...
                <form action="Logins/jobseekerlogin.php" method="POST">
